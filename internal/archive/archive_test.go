...
func (s *httpSuite) TestPackageInfo(c *C) {
	...
	info1, err := archive.Info("mypkg1")
	c.Assert(err, IsNil)
	c.Assert(info1, NotNil)
	c.Assert(info1.Name(), Equals, "mypkg1")
	c.Assert(info1.Version(), Equals, "1.1")
	c.Assert(info1.Arch(), Equals, "amd64")
	c.Assert(info1.Hash(), Equals, "1f08ef04cfe7a8087ee38a1ea35fa1810246648136c3c42d5a61ad6503d85e05")

	info3, err := archive.Info("mypkg3")
	c.Assert(err, IsNil)
	c.Assert(info3, NotNil)
	c.Assert(info3.Name(), Equals, "mypkg3")
	c.Assert(info3.Version(), Equals, "1.3")
	c.Assert(info3.Arch(), Equals, "amd64")
	c.Assert(info3.Hash(), Equals, "fe377bf13ba1a5cb287cb4e037e6e7321281c929405ae39a72358ef0f5d179aa")

	info99, err := archive.Info("mypkg99")
	c.Assert(err, NotNil)
